...
public class TabHeaderTag extends TagSupport {
    ...
    static {
        ...
        FORWARDS.add(new MenuForward(MessagesCommon.MAIN_MENU_ITEM_SEARCH_PROCESSES));
        ...
        FORWARDS.add(new MenuForward(MessagesCommon.MAIN_MENU_ITEM_FROZEN_PROCESSES, SecuredSingleton.FROZEN_PROCESSES, true));
