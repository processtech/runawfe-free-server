...
public final class MessagesException {
    ...
    public static final StrutsMessage DEFINITION_MAX_SUBVERSION_ERROR = new StrutsMessage("definition.max.subversion.error");
    public static final StrutsMessage DEFINITION_SMALL_DELTA_SUBVERSION_ERROR = new StrutsMessage("definition.small.delta.subversion.error");
