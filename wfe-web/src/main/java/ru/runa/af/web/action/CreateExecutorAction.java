    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            if (CreateExecutorForm.TYPE_ACTOR.equals(createFrom.getExecutorType())) {
                ...
                Actor actor = new Actor(createFrom.getNewName(), createFrom.getDescription(), createFrom.getFullName(), code, createFrom.getEmail(),
                        createFrom.getPhone(), createFrom.getTitle(), createFrom.getDepartment());
                actor.setTaskEmailNotificationsEnabled(createFrom.getTaskEmailNotificationsEnabled());
                actor.setChatEmailNotificationsEnabled(createFrom.getChatEmailNotificationsEnabled());
                Delegates.getExecutorService().create(getLoggedUser(request), actor);
