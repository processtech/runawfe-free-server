...
public class AjaxGetProcessVariablesList extends JsonAjaxCommand {
    ...
    protected JSONAware execute(User user, HttpServletRequest request) throws Exception {
        try {
            ...
            List<VariableDefinition> variables = getDefinitions(user, process.getDefinitionId());
    ...
    protected List<VariableDefinition> getDefinitions(User user, long definitionId) {
        return Delegates.getDefinitionService().getVariableDefinitions(user, definitionId);
    }
}
