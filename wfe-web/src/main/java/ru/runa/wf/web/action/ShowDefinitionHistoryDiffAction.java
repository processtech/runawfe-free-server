...
public class ShowDefinitionHistoryDiffAction extends ActionBase {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        ProcessDefinition processDefinition1 = showSingleVersionMode ? null
                : Delegates.getDefinitionService().getParsedProcessDefinition(Commons.getUser(request.getSession()), definition1.getId());
        ProcessDefinition processDefinition2 = Delegates.getDefinitionService().getParsedProcessDefinition(Commons.getUser(request.getSession()),
                definition2.getId());
