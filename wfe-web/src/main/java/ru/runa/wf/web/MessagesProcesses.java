...
public final class MessagesProcesses {
    ...
    public static final StrutsMessage PROCESS_LOCKED = new StrutsMessage("process.locked");
    public static final StrutsMessage PROCESS_LOCKED_FOR_ALL = new StrutsMessage("process.locked_for_all");
    public static final StrutsMessage PROCESS_REMOVED = new StrutsMessage("process.removed");
    public static final StrutsMessage PROCESS_UNLOCKED = new StrutsMessage("process.unlocked");
