...
import ru.runa.wf.web.action.ExportRootCertificateAction;
import ru.runa.wfe.commons.web.PortletUrlType;
import ru.runa.wfe.service.delegate.Delegates;
@org.tldgen.annotations.Tag(bodyContent = BodyContent.JSP, name = "exportRootCertificate")
public class ExportRootCertificateTag  extends VisibleTag {
    ...
    protected ConcreteElement getEndElement() {
        ...
        if (Delegates.getExecutorService().isAdministrator(getUser())) {
            String downloadUrl = Commons.getActionUrl(ExportRootCertificateAction.ACTION_PATH, pageContext, PortletUrlType.Render);
    ...
    protected String getTitle() {
        return MessagesOther.TITLE_EXPORT_ROOT_CERTIFICATE.message(pageContext);
    }
}
