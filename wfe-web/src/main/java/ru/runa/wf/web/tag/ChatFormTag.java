...
import ru.runa.wf.web.MessagesChat;
...
public class ChatFormTag extends TitledFormTag {
    ...
    private TR getButtons() {
        Input sendMessageButton = new Input("button", "sendMessageButton", MessagesChat.SEND_MESSAGE.message(pageContext));
        ...
        TD sendMessageTd = new TD(sendMessageButton)
                .addElement(new Div(MessagesChat.PRIVATE_MESSAGE.message(pageContext)).setClass("text message-card-header private-message-label"))
