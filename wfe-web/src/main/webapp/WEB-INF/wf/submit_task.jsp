...
<% if (WebResources.isAjaxFileInputEnabled()) { %>
	...
	<script type="text/javascript" src="/wfe/js/i18n/delegate.dialog-<%= Commons.getLocale(pageContext).getLanguage() %>.js?<%=GitProperties.getCommit()%>">c=0;</script>
	<script type="text/javascript" src="<html:rewrite page='<%="/js/delegate.dialog.js?"+GitProperties.getCommit() %>' />">c=0;</script>
	...
	<link rel="stylesheet" type="text/css" href="<html:rewrite page='<%="/css/delegate.dialog.css?"+GitProperties.getCommit() %>' />">
<% 
   }
