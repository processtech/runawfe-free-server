$.processesUpgradeDialog = undefined;
function selectProcessesUpgrageVersionDialog(link) {
			...
			buttons: [
				{
					text: "Ok",
					click: function() {
						submitProcessesUpgrade();
					}
				},
				{
					text: buttonCancelMessage,
					click: function() {
						$.processesUpgradeDialog.dialog("close");
					}
				}
			]
		});
