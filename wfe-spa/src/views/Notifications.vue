      ...
      >
        <app-card>
          <v-card-text>
            ...
            >
              <span
                class="text-uppercase caption font-weight-medium"
                v-text="color"
            ...
            <material-alert
              ...
              dismissible
            >
              <span class="caption font-weight-medium">PRIMARY</span> — This is a regular alert made with the color "secondary"
            </material-alert>
            ...
            <material-alert
              ...
              dismissible
            >
              <span class="caption font-weight-medium">PINK DARKEN-1</span> — This is a regular alert made with the color "pink darken-1"
            </material-alert>
          </v-card-text>
        </app-card>
      </v-col>
...
<script lang="ts">
  ...
  export default Vue.extend({
    name: 'NotificationsView' as string,
