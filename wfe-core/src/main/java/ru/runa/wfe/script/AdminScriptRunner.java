...
public class AdminScriptRunner {
    ...
    /**
     * Called to prepare/transform script. For example if script executed for some bot station, when all bot station operations may receive new
    ...
    /**
     * Wrap every operation to handle exceptions, occured during operation execution/validation.
     * 
     * @param data
     * @param errorHandler
     */
