 ...
 *
 */
public class NameCaseRussian extends Function<String> {

    private static final Log log = LogFactory.getLog(NameCaseRussian.class);
    ...
    protected String doExecute(Object... parameters) {
        if (parameters.length == 3) {
            ...
            return nameCaseRussian(fio, caseNumber, mode);
        } else if (parameters.length == 4) {
            String fio = (String) parameters[0];
            int caseNumber = (int) parameters[1];
            boolean sex = (boolean) parameters[2];
    ...
    private String nameCaseRussian(String fio, int caseNumber, String mode) {
        boolean sex = false;
    ...
    private String nameCaseRussian(String fio, int caseNumber, boolean sex, String mode) {
        StringTokenizer st = new StringTokenizer(fio);
