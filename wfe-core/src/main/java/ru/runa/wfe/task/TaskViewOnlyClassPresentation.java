 ...
 */
public class TaskViewOnlyClassPresentation extends ClassPresentation {
    ...
    private static final ClassPresentation INSTANCE = new TaskViewOnlyClassPresentation();
    ...
    private TaskViewOnlyClassPresentation() {
