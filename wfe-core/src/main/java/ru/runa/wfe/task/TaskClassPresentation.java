...
public class TaskClassPresentation extends ClassPresentation {
    ...
    private TaskClassPresentation() {
        super(Task.class, "", false, new FieldDescriptor[] {
                ...
                new FieldDescriptor(TASK_CREATE_DATE, Date.class.getName(), new DefaultDBSource(Task.class, null), true, FieldFilterMode.DATABASE,
                        "ru.runa.wf.web.html.TaskCreationDateTDBuilder", new Object[] {}),
