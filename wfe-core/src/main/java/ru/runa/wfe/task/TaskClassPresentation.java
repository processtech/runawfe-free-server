    ...
    private TaskClassPresentation() {
        super(Task.class, "", false, new FieldDescriptor[] {
                ...
                new FieldDescriptor(DEFINITION_NAME, String.class.getName(), new DefaultDbSource(Task.class, "process.definition.pack.name"),
                        true, FieldFilterMode.DATABASE, "ru.runa.wf.web.html.TaskProcessDefinitionTdBuilder", new Object[] {}).setVisible(false),
                new FieldDescriptor(ROOT_DEFINITION_NAME, String.class.getName(), new DefaultDbSource(Task.class, "process.definition.pack.name"), false,
