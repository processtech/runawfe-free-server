...
public class TaskClassPresentation extends ClassPresentation {
    ...
    private TaskClassPresentation() {
        super(Task.class, "", false, new FieldDescriptor[] {
                ...
                new FieldDescriptor(TASK_OBSERVABLE_EXECUTOR, ObservableTasksFilterCriteria.class.getName(),
                        new DefaultDBSource(Task.class, "executor.id"), false, FieldFilterMode.DATABASE,
