...
public class ProcessDefinitionWithContent implements Serializable {
    ...
    public ProcessDefinitionWithContent() {
    }

    public ProcessDefinitionWithContent(ProcessDefinition processDefinition, byte[] content) {
        setCreateActor(processDefinition.getCreateActor());
        setCreateDate(processDefinition.getCreateDate());
        setId(processDefinition.getId());
        setSubprocessBindingDate(processDefinition.getSubprocessBindingDate());
        setVersion(processDefinition.getVersion());
        setContent(content);
        setUpdateActor(processDefinition.getUpdateActor());
        setUpdateDate(processDefinition.getUpdateDate());
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProcessDefinitionWithContent)) {
            return false;
        }
        ProcessDefinitionWithContent x = (ProcessDefinitionWithContent) o;
