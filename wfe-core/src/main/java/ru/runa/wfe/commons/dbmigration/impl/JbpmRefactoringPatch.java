...
public class JbpmRefactoringPatch extends DbMigration {
    ...
    protected void executeDDLBefore() {
        ...
        executeUpdates(
                ...
                getDDLRenameColumn("BATCH_PRESENTATION", "PRESENTATION_NAME", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BATCH_PRESENTATION", "PRESENTATION_ID", new ColumnDef("CATEGORY", dialect.getTypeName(Types.VARCHAR))),
                getDDLCreateColumn("BATCH_PRESENTATION", new ColumnDef("IS_ACTIVE", dialect.getTypeName(Types.TINYINT))),
                getDDLCreateColumn("BATCH_PRESENTATION", new ColumnDef("FIELDS", dialect.getTypeName(Types.VARBINARY))),
                getDDLCreateColumn("BATCH_PRESENTATION", new VarcharColumnDef("CLASS_TYPE", 255)),
                ...
                getDDLRenameColumn("ACTOR_PASSWORD", "PASSWD", new ColumnDef("PASSWORD", dialect.getTypeName(Types.VARBINARY))),
                ...
                getDDLRenameColumn("BOT", "LAST_INVOKED", new ColumnDef("START_TIMEOUT", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BOT", "WFE_USER", new ColumnDef("USERNAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BOT", "WFE_PASS", new ColumnDef("PASSWORD", dialect.getTypeName(Types.VARCHAR))),
                getDDLCreateColumn("BOT", new BigintColumnDef("VERSION")),
                ...
                getDDLRenameColumn("BOT_TASK", "CLAZZ", new ColumnDef("TASK_HANDLER", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameIndex("BOT_TASK", getObjectName("BT_B_IDX"), "IX_BOT_TASK_BOT"),
                getDDLCreateColumn("BOT_TASK", new BigintColumnDef("VERSION")),
                // ru.runa.wfe.user.Executor
                getDDLRenameTable("EXECUTORS", "EXECUTOR"),
                getDDLRenameColumn("EXECUTOR", "IS_GROUP", new ColumnDef("DISCRIMINATOR", dialect.getTypeName(Types.VARCHAR))),
                getDDLCreateColumn("EXECUTOR", new IntColumnDef("ESCALATION_LEVEL")),
                getDDLCreateColumn("EXECUTOR", new BigintColumnDef("ESCALATION_EXECUTOR_ID")),
                ...
                getDDLRenameColumn("EXECUTOR_RELATION_PAIR", "RELATION_GROUP", new BigintColumnDef("RELATION_ID")),
                ...
                getDDLCreateTable("PERMISSION_MAPPING", list(
                        ...
                        new BigintColumnDef("MASK").notNull(),
                        new BigintColumnDef("IDENTIFIABLE_ID").notNull(),
                        new BigintColumnDef("EXECUTOR_ID").notNull()
                )),
                ...
                getDDLRenameColumn("SUBSTITUTION", "IS_TERMINATOR", new ColumnDef("DISCRIMINATOR", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("SUBSTITUTION", "SUBSITUTION_ORG_FUNCTION", new ColumnDef("ORG_FUNCTION", dialect.getTypeName(Types.VARCHAR))),
                ...
                getDDLRenameColumn("BPM_PROCESS_DEFINITION", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_PROCESS_DEFINITION", "NAME_", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_PROCESS_DEFINITION", "DESCRIPTION_", new ColumnDef("DESCRIPTION", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_PROCESS_DEFINITION", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLCreateColumn("BPM_PROCESS_DEFINITION", new VarcharColumnDef("LANGUAGE", 255)),
                getDDLCreateColumn("BPM_PROCESS_DEFINITION", new VarcharColumnDef("CATEGORY", 255)),
                getDDLCreateColumn("BPM_PROCESS_DEFINITION", new ColumnDef("BYTES", dialect.getTypeName(Types.VARBINARY))),
                getDDLCreateColumn("BPM_PROCESS_DEFINITION", new ColumnDef("DEPLOYED", dialect.getTypeName(Types.TIMESTAMP))),
                ...
                getDDLRenameColumn("BPM_PROCESS", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_PROCESS", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLRenameColumn("BPM_PROCESS", "START_", new ColumnDef("START_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_PROCESS", "END_", new ColumnDef("END_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_PROCESS", "PROCESSDEFINITION_", new BigintColumnDef("DEFINITION_ID")),
                ...
                getDDLRenameColumn("BPM_PROCESS", "ROOTTOKEN_", new BigintColumnDef("ROOT_TOKEN_ID")),
                ...
                getDDLRenameColumn("BPM_TOKEN", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_TOKEN", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLRenameColumn("BPM_TOKEN", "NAME_", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_TOKEN", "START_", new ColumnDef("START_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_TOKEN", "END_", new ColumnDef("END_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_TOKEN", "PROCESSINSTANCE_", new BigintColumnDef("PROCESS_ID")),
                getDDLRenameForeignKey(getObjectName("FK_TOKEN_PROCINST"), "FK_TOKEN_PROCESS"),
                getDDLRenameColumn("BPM_TOKEN", "PARENT_", new BigintColumnDef("PARENT_ID")),
                getDDLRenameColumn("BPM_TOKEN", "ISABLETOREACTIVATEPARENT_", new ColumnDef("REACTIVATE_PARENT", dialect.getTypeName(Types.VARCHAR))),
                ...
                getDDLRenameColumn("BPM_SWIMLANE", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_SWIMLANE", "NAME_", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_SWIMLANE", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLCreateColumn("BPM_SWIMLANE", new BigintColumnDef("PROCESS_ID")),
                getDDLCreateForeignKey("BPM_SWIMLANE", "FK_SWIMLANE_PROCESS", "PROCESS_ID", "BPM_PROCESS", "ID"),
                getDDLCreateColumn("BPM_SWIMLANE", new BigintColumnDef("EXECUTOR_ID")),
        ...
        executeUpdates(
                ...
                getDDLRenameColumn("BPM_TASK", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_TASK", "NAME_", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_TASK", "DESCRIPTION_", new ColumnDef("DESCRIPTION", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_TASK", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLRenameColumn("BPM_TASK", "CREATE_", new ColumnDef("CREATE_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_TASK", "END_", new ColumnDef("END_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_TASK", "DUEDATE_", new ColumnDef("DEADLINE_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_TASK", "TOKEN_", new BigintColumnDef("TOKEN_ID")),
                ...
                getDDLRenameColumn("BPM_TASK", "SWIMLANINSTANCE_", new BigintColumnDef("SWIMLANE_ID")),
                ...
                getDDLRenameColumn("BPM_TASK", "PROCINST_", new BigintColumnDef("PROCESS_ID")),
                getDDLRenameForeignKey(getObjectName("FK_TSKINS_PRCINS"), "FK_TASK_PROCESS"),
                getDDLCreateColumn("BPM_TASK", new ColumnDef("FIRST_OPEN", dialect.getTypeName(Types.TINYINT))),
                getDDLCreateColumn("BPM_TASK", new VarcharColumnDef("NODE_ID", 255)),
                getDDLCreateColumn("BPM_TASK", new BigintColumnDef("EXECUTOR_ID")),
        ...
        executeUpdates(
                ...
                getDDLRenameColumn("BPM_LOG", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_LOG", "CLASS_", new CharColumnDef("DISCRIMINATOR", 1))
        );
        ...
        executeUpdates(
                ...
                getDDLRenameColumn("BPM_LOG", "DATE_", new ColumnDef("LOG_DATE", dialect.getTypeName(Types.DATE))),
                getDDLDropForeignKey("BPM_LOG", getObjectName("FK_LOG_TOKEN")),
                getDDLRenameColumn("BPM_LOG", "TOKEN_", new BigintColumnDef("TOKEN_ID")),
                ...
                getDDLCreateColumn("BPM_LOG", new ColumnDef("BYTES", dialect.getTypeName(Types.VARBINARY))),
                ...
                getDDLRenameColumn("BPM_JOB", "CLASS_", new CharColumnDef("DISCRIMINATOR", 1)),
                getDDLRenameColumn("BPM_JOB", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_JOB", "NAME_", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_JOB", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLRenameColumn("BPM_JOB", "DUEDATE_", new ColumnDef("DUE_DATE", dialect.getTypeName(Types.DATE))),
                getDDLRenameColumn("BPM_JOB", "PROCESSINSTANCE_", new BigintColumnDef("PROCESS_ID")),
                getDDLRenameIndex("BPM_JOB", getObjectName("IDX_JOB_PRINST"), "IX_JOB_PROCESS"),
                getDDLDropIndex("BPM_JOB", getObjectName("IDX_JOB_TOKEN")),
                getDDLRenameColumn("BPM_JOB", "TOKEN_", new BigintColumnDef("TOKEN_ID")),
        ...
        executeUpdates(
                ...
                getDDLRenameColumn("BPM_VARIABLE", "CLASS_", new CharColumnDef("DISCRIMINATOR", 1)),
                getDDLRenameColumn("BPM_VARIABLE", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_VARIABLE", "NAME_", new ColumnDef("NAME", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_VARIABLE", "VERSION_", new BigintColumnDef("VERSION")),
                getDDLRenameColumn("BPM_VARIABLE", "CONVERTER_", new ColumnDef("CONVERTER", dialect.getTypeName(Types.CHAR))),
                getDDLRenameColumn("BPM_VARIABLE", "PROCESSINSTANCE_", new BigintColumnDef("PROCESS_ID")),
                ...
                getDDLRenameColumn("BPM_VARIABLE", "LONGVALUE_", new BigintColumnDef("LONGVALUE")),
                getDDLRenameColumn("BPM_VARIABLE", "STRINGVALUE_", new ColumnDef("STRINGVALUE", dialect.getTypeName(Types.VARCHAR))),
                getDDLRenameColumn("BPM_VARIABLE", "DATEVALUE_", new ColumnDef("DATEVALUE", dialect.getTypeName(Types.DATE))),
                ...
                getDDLRenameColumn("BPM_SUBPROCESS", "ID_", new BigintColumnDef("ID")),
                getDDLRenameColumn("BPM_SUBPROCESS", "PROCESSINSTANCE_", new BigintColumnDef("PARENT_PROCESS_ID")),
                ...
                getDDLRenameColumn("BPM_SUBPROCESS", "SUBPROCESSINSTANCE_", new BigintColumnDef("PROCESS_ID")),
                ...
                getDDLCreateColumn("JBPM_PASSTRANS", new VarcharColumnDef("TRANSITION_ID", 255)),
                getDDLRenameColumn("JBPM_PASSTRANS", "ID_", new BigintColumnDef("ID")),
