...
public class CachingLogic {
     ...
     */
    private static Set<ChangeListener> executorListeners = new HashSet<>();
    /**
     * {@link ChangeListener}, which must be notified, when substitution related object change.
     */
    private static Set<ChangeListener> substitutionListeners = new HashSet<>();
    /**
     * {@link ChangeListener}, which must be notified, when task instance related object change.
     */
    private static Set<ChangeListener> taskListeners = new HashSet<>();
    /**
     * {@link ChangeListener}, which must be notified, when process definition related object change.
     */
    private static Set<ChangeListener> processDefListeners = new HashSet<>();

    /**
     * Register listener. Listener will be notified on events, according to implemented interfaces.
     */
    public static synchronized void registerChangeListener(ExecutorChangeListener listener) {
        executorListeners.add(new ChangeListenerGuard(listener));
    }
    public static synchronized void registerChangeListener(ProcessDefChangeListener listener) {
        processDefListeners.add(new ChangeListenerGuard(listener));
    }
    public static synchronized void registerChangeListener(SubstitutionChangeListener listener) {
        substitutionListeners.add(new ChangeListenerGuard(listener));
    }
    public static synchronized void registerChangeListener(TaskChangeListener listener) {
        taskListeners.add(new ChangeListenerGuard(listener));
    }
