...
public class ExpandVarcharPatch extends DBPatch {
    ...
    protected List<String> getDDLQueriesBefore() {
        ...
        sql.add(getDDLModifyColumn("BATCH_PRESENTATION", "CATEGORY",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BATCH_PRESENTATION", "CLASS_TYPE",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        ...
        sql.add(getDDLModifyColumn("BPM_AGGLOG_ASSIGNMENTS", "NEW_EXECUTOR_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_ASSIGNMENTS", "OLD_EXECUTOR_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_PROCESS", "CANCEL_ACTOR_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_PROCESS", "START_ACTOR_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_TASKS", "COMPLETE_ACTOR_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_TASKS", "INITIAL_ACTOR_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_TASKS", "NODE_ID", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_TASKS", "SWIMLANE_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_AGGLOG_TASKS", "TASK_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        ...
        sql.add(getDDLModifyColumn("BPM_PROCESS_DEFINITION", "CATEGORY",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_PROCESS_DEFINITION", "LANGUAGE",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("BPM_PROCESS_DEFINITION", "NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        ...
        sql.add(getDDLModifyColumn("BPM_SUBPROCESS", "PARENT_NODE_ID",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        ...
        sql.add(getDDLModifyColumn("REPORT", "NAME", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("REPORT", "PARAM_BUILDER_NAME", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("REPORT", "CONFIG_TYPE", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("REPORT", "CATEGORY", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("REPORT_PARAMETER", "NAME", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("REPORT_PARAMETER", "TYPE", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("REPORT_PARAMETER", "INNER_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("SUBSTITUTION", "ORG_FUNCTION", dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("SUBSTITUTION_CRITERIA", "CONF",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("SUBSTITUTION_CRITERIA", "NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
        sql.add(getDDLModifyColumn("SYSTEM_LOG", "PROCESS_DEFINITION_NAME",
                dialect.getTypeName(Types.VARCHAR, 1024, 1024, 1024)));
