...
public class ApplicationContextFactory implements ApplicationContextAware {
    ...
    public static EventSubprocessTriggerDao getEventSubprocessTriggerDao() {
        return getContext().getBean(EventSubprocessTriggerDao.class);
    }
    ...
    public static TransactionalExecutor getTransactionalExecutor() {
        return getContext().getBean(TransactionalExecutor.class);
    }
