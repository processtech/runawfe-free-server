...
public class Utils {
    ...
    public static void sendBpmnErrorMessage(Long processId, String nodeId, BusinessException businessException) {
        Map<String, Object> variables = Maps.newHashMap();
        variables.put(BaseMessageNode.EVENT_TYPE, MessageEventType.error.name());
        variables.put(BaseMessageNode.BUSINESS_EXCEPTION_MESSAGE, businessException.getMessage());
