...
public class TokenErrorClassPresentation extends ClassPresentation {
    ...
    private TokenErrorClassPresentation() {
        super(
                ...
                new FieldDescriptor(PROCESS_TYPE, String.class.getName(), new DefaultDbSource(CurrentToken.class, "process.definition.pack.category"), true,
                        FieldFilterMode.DATABASE, "ru.runa.common.web.html.PropertyTdBuilder", new Object[]{Permission.READ, "processType"}),
                new FieldDescriptor(PROCESS_NAME, String.class.getName(), new DefaultDbSource(CurrentToken.class, "process.definition.pack.name"), true,
                        FieldFilterMode.DATABASE, "ru.runa.common.web.html.PropertyTdBuilder", new Object[]{Permission.READ, "processName"}),
                new FieldDescriptor(PROCESS_VERSION, Integer.class.getName(), new DefaultDbSource(CurrentToken.class, "process.definition.version"), true,
