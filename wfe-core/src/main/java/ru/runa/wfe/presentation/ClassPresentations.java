...
import ru.runa.wfe.task.TaskViewOnlyClassPresentation;
...
public class ClassPresentations {
    ...
    static {
        ...
        registerClassPresentation(ClassPresentationType.TASK_VIEW_ONLY, TaskViewOnlyClassPresentation.getInstance());
