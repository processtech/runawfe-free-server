...
public interface ProcessLog extends Attributes, Comparable<ProcessLog>, Serializable {
    ...
    enum Type {
        ...
        TASK_EXPIRED(CurrentTaskCancelledByExceededLifetimeLog.class, ArchivedTaskCancelledByExceededLifetimeLog.class),
        TASK_REMOVED_ON_PROCESS_END(CurrentTaskCancelledByProcessEndLog.class, ArchivedTaskCancelledByProcessEndLog.class),
