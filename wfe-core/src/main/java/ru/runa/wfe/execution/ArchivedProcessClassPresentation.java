...
public class ArchivedProcessClassPresentation extends ClassPresentation {
    ...
    private ArchivedProcessClassPresentation() {
        super(ArchivedProcess.class, "", true, new FieldDescriptor[] {
                ...
                new FieldDescriptor(DEFINITION_NAME, String.class.getName(), new DefaultDbSource(ArchivedProcess.class, "deployment.name"), true,
                ...
                new FieldDescriptor(DEFINITION_VERSION, Integer.class.getName(), new DefaultDbSource(ArchivedProcess.class, "deployment.version"), true,
                ...
                new FieldDescriptor(PROCESS_EXECUTION_STATUS, String.class.getName(), new DefaultDbSource(ArchivedProcess.class, "executionStatus"), true,
