...
public class TestCacheStateMachineAudit<CacheImpl extends CacheImplementation> implements CacheStateMachineAudit<CacheImpl> {
    ...
    private volatile GetCacheAudit<CacheImpl> _getCacheAudit = new TestGetCacheAudit<CacheImpl>();

    private volatile OnChangeAudit<CacheImpl> _onChangeAudit = new TestOnChangeAudit<CacheImpl>();

    private volatile CompleteTransactionAudit<CacheImpl> _completeTransactionAudit = new TestCompleteTransactionAudit<CacheImpl>();

    private volatile CommitCacheAudit<CacheImpl> _commitCacheAudit = new TestCommitCacheAudit<CacheImpl>();

    private volatile InitializationErrorAudit<CacheImpl> _initializationErrorAudit = new TestInitializationErrorAudit<CacheImpl>();

    private volatile StageSwitchAudit<CacheImpl> _uninitializeAudit = new TestStageSwitchAudit<CacheImpl>();

    private volatile BeforeTransactionCompleteAudit<CacheImpl> _beforeTransactionCompleteAudit = new TestBeforeTransactionCompleteAudit<CacheImpl>();
    ...
    public static class TestGetCacheAudit<CacheImpl extends CacheImplementation> extends TestStageSwitchAudit<CacheImpl> implements
            GetCacheAudit<CacheImpl> {
    ...
    public static class TestOnChangeAudit<CacheImpl extends CacheImplementation> extends TestStageSwitchAudit<CacheImpl> implements
            OnChangeAudit<CacheImpl> {
    ...
    public static class TestCompleteTransactionAudit<CacheImpl extends CacheImplementation> extends TestStageSwitchAudit<CacheImpl> implements
            CompleteTransactionAudit<CacheImpl> {
    ...
    public static class TestCommitCacheAudit<CacheImpl extends CacheImplementation> extends TestStageSwitchAudit<CacheImpl> implements
            CommitCacheAudit<CacheImpl> {
    ...
    public static class TestInitializationErrorAudit<CacheImpl extends CacheImplementation> extends TestStageSwitchAudit<CacheImpl> implements
            InitializationErrorAudit<CacheImpl> {
    ...
    public static class TestBeforeTransactionCompleteAudit<CacheImpl extends CacheImplementation> extends TestStageSwitchAudit<CacheImpl> implements
            BeforeTransactionCompleteAudit<CacheImpl> {
    }
}
