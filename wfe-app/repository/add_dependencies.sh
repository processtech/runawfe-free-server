...
mvn install:install-file -Dfile=olap4j-0.9.7.309-JS-3.jar -DpomFile=olap4j-0.9.7.309-JS-3.pom
mvn install:install-file -Dfile=itext-2.1.7.js9.jar -DgroupId=com.lowagie -DartifactId=itext -Dversion=2.1.7.js9 -Dpackaging=jar -DgeneratePom=true
