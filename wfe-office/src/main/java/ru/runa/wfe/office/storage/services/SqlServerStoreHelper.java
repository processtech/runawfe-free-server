...
public class SqlServerStoreHelper implements StoreHelper {

    private static final Log log = LogFactory.getLog(SqlServerStoreHelper.class);
    ...
    public SqlServerStoreHelper(DataBindings config, IVariableProvider variableProvider) {
        setConfig(config);
        registerHandlers();
